...
const fs = require("fs");
const FaceDetector = require("./FaceDetector.js");
...
// -----------------------
    ...
    __takePhoto() {
        ...
        this.camera.on('capturedata', function(data) {
            ...
            if (self.captureReady) {
                ...
                let result = self.__analyze(data);
                self.__score(result);
    ...
    __analyze(data) {
        ...
        let faceDetector = new bindings.FaceDetector(array);
        //let faceDetector = new FaceDetector();
        //console.log(TAG, "FaceDetector constructor success");
        if (!faceDetector.hasFace) {
            console.log(TAG, "No Face!!");
            return;
        }
        let face = faceDetector.defaultFace;
    ...
    __isFaceDetected(faceDetector) {
        return faceDetector.hasFace;
    }
